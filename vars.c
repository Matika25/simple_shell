...
/**
 * is_chain - it tests current char in buffer is a chain delimeter
 * @info: parameter struct
 * @buf: char buffer
 * @p: addresses current position in buf
 *
 ...
 * @info: parameter struct
 * @buf: char buffer
 * @p: it addresses current position in buf
